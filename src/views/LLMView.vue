...
<template>
  <div class="relative h-screen flex flex-col">
      ...
      <transition name="slide">
        ...
        >
          ...
          <div class="text-center mb-4">
            <h2 class="text-2xl font-bold text-gray-800 dark:text-white">CO₂ Statistics</h2>
            <p class="text-sm text-gray-600 dark:text-gray-300">Mock visualisations</p>
          </div>
          <!-- Visualisations -->
          <div class="grid gap-4">
            ...
            <div class="flex items-center p-4 border rounded-lg shadow">
              ...
              <div class="ml-4">
                <div class="text-xl font-bold text-gray-800 dark:text-white">2.5 kg</div>
                <div class="text-sm text-gray-500">CO₂ used in this session</div>
              </div>
            </div>
            ...
            <div class="flex items-center p-4 border rounded-lg shadow">
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <path d="M9 9H5V5h4v4zM15 9h4V5h-4v4zM15 15h4v-4h-4v4zM9 15H5v-4h4v4z" />
              </svg>
              <div class="ml-4">
                <div class="text-xl font-bold text-gray-800 dark:text-white">1.2 kg</div>
                <div class="text-sm text-gray-500">CO₂ used from this model</div>
              </div>
            </div>
            ...
            <div class="flex items-center p-4 border rounded-lg shadow">
              ...
              <div class="ml-4">
                <div class="text-xl font-bold text-gray-800 dark:text-white">3 Trees</div>
                <div class="text-sm text-gray-500">Suggested trees to plant</div>
              </div>
            </div>
          </div>
          <!-- Plant Now Button -->
    ...
    <transition name="fade">
      ...
      >
        <div class="bg-green-50 dark:bg-green-900 rounded-lg shadow-lg p-6 w-[40vw] relative border border-green-200 dark:border-green-700">
          <!-- Close Button -->
          <button
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="w-16 h-16 mx-auto text-green-600 mb-4"
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            stroke-width="2"
          ...
          <p class="mb-4 text-gray-600 dark:text-gray-300 text-center">
            Your donation will help us plant more trees and offset CO₂ emissions.
          </p>
          <div class="mb-4">
            <label for="donationAmount" class="block text-gray-800 dark:text-white mb-2">
              Donation Amount ($)
            </label>
            <input
              type="number"
          ...
          <div class="mb-4">
            <label for="donorName" class="block text-gray-800 dark:text-white mb-2">
              Name
            </label>
            <input
              type="text"
          ...
          <div class="mb-4">
            <label for="donorEmail" class="block text-gray-800 dark:text-white mb-2">
              Email
            </label>
            <input
              type="email"
      ...
      <div class="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto text-center">
        <div class="inline-block mb-4 flex-none">
          <div class="flex items-center justify-center gap-2">
            ...
            <span class="text-xl font-bold text-gray-800 dark:text-white">LLM 2 Leaf</span>
          </div>
        </div>
